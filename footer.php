...
jQuery(document).ready(function ($) {
    ...
    // Delegate the events to the document (or a parent container) to handle dynamically loaded content
    $(document).on("mousedown touchstart", ".ba-Slider .slider2", function(e) {
        e.preventDefault();
        moveSlider = true;
        var $this = $(this).closest('.ba-Slider'); // Find the closest .ba-Slider container
